...
export default class DamageItem extends ItemBase {
  ...
  constructor(room: Room, position: Phaser.Math.Vector2) {
    ...
    this.sprite = this.room.scene.physics.add.sprite(this.startPosition.x, this.startPosition.y, 'item_3');
    this.sprite.play('item_3_idle');
    this.initColliders();
  }
